use windows::{
    ...
    Win32::System::Threading::{OpenProcess, PROCESS_QUERY_LIMITED_INFORMATION, PROCESS_NAME_NATIVE, QueryFullProcessImageNameW},
};
...
impl WindowsFocusHandler {
    ...
    pub fn get_process_ids() -> Result<Vec<u32>, WindowFocusError> {
        unsafe{
            ...
            let result = EnumProcesses(buffer.as_mut_ptr(), (MAX_PROCESS_COUNT*std::mem::size_of::<u32>()) as u32, &mut bytes_written)?;
